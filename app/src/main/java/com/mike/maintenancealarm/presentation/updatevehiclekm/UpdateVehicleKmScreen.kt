...
fun UpdateVehicleKmScreenComposable(
    ...
    val viewModel: UpdateVehicleKmViewModel =
        hiltViewModel<UpdateVehicleKmViewModel, UpdateVehicleKmViewModel.Factory>(
...
fun UpdateVehicleKmScreenContent(
    ...
    Column(
        ...
        InputFieldView(
            modifier = Modifier.padding(top = SPACING_LARGE, start = SPACING_LARGE, end = SPACING_LARGE),
